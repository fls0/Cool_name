...
def main():
    ...
    IMAGE_PATH = "Game/moution"
    PLAYER_IMAGES = os.listdir(IMAGE_PATH)
    
    main_display = pygame.display.set_mode((WIDTH, HEIGHT))
    
    bg = pygame.transform.scale( pygame.image.load('Game/background.png'),(WIDTH,HEIGHT))
    bg_X1 = 0
    bg_X2 = bg.get_width()
    bg_move=4
    ...
    def create_gameover():
        ...
        gameover = pygame.image.load('Game/gameover.png').convert_alpha()
